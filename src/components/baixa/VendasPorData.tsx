...
export default function VendasPorData({ vendas, selecionadas, onToggle }: VendasPorDataProps) {
  if (vendas.length === 0) {
    return (
  ...
  // Agrupa mantendo a ordem já vinda do servidor (mais antigas primeiro)
